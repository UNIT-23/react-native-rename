...
function filesToModifyContent(currentAppName, newName, currentDisplayName, newDisplayName) {
  ...
  return [{
    ...
    paths: ['index.js', 'index.android.js', 'index.ios.js', 'ios/' + nS_NewName + '.xcodeproj/project.pbxproj', 'ios/' + nS_NewName + '.xcworkspace/contents.xcworkspacedata', 'ios/' + nS_NewName + '.xcodeproj/xcshareddata/xcschemes/' + nS_NewName + '-tvOS.xcscheme', 'ios/' + nS_NewName + '.xcodeproj/xcshareddata/xcschemes/' + nS_NewName + '.xcscheme', 'ios/' + nS_NewName + '/AppDelegate.m', 'android/settings.gradle', 'ios/' + nS_NewName + 'Tests/' + nS_NewName + 'Tests.m', 'ios/build/info.plist', 'ios/Podfile']
  }, {
