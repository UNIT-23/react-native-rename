...
readFile(_path2.default.join(__dirname, 'android/app/src/main/res/values/strings.xml')).then(function (data) {
  ...
  var currentAppName = require("../../../app.json").name;
  ...
  _commander2.default.version('2.2.2').arguments('<newName>').option('-b, --bundleID [value]', 'Set custom bundle identifier eg. "com.junedomingo.travelapp"').option('-d, --displayName [value]', 'Set custom display name eg. "travelapp"').action(function (newName) {
    ...
    var displayName = _commander2.default.displayName ? _commander2.default.displayName.toLowerCase() : null;
    var newBundlePath = void 0;
    var listOfFoldersAndFiles = (0, _foldersAndFiles.foldersAndFiles)(currentAppName, newName);
    var listOfFilesToModifyContent = (0, _filesToModifyContent.filesToModifyContent)(currentAppName, newName, displayName);
